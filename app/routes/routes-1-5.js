module.exports = function (router) {
    ...
    router.get('/1-5/AO/action-reload-data', function (req, res) {
    ...
    router.post('/1-5/AO/ao-my-services', function (req, res) {
    ...
    router.get('/1-5/AO/action-ao-verify-tLevels', function (req, res) {
        ...
        res.redirect('/1-5/AO/ao-verify-tLevels?tl=' + req.session.data['requested_tLevel'])
    })

    router.get('/1-5/AO/action-verify-single-tLevel', function (req, res) {
    ...
    router.get('/1-5/AO/action-ao-providers', function (req, res) {
        ...
        res.redirect('/1-5/AO/ao-providers')
    })

    router.get('/1-5/AO/action-search-providers', function (req, res) {
    ...
    router.get('/1-5/AO/action-ao-views-provider', function (req, res) {
        /*
        ...
        */
        ...
        req.session.save()
        res.redirect('/1-5/AO/ao-views-provider')
    })

    router.post('/1-5/AO/action-import-providers-single', function (req, res) {
        /*
    ...
    router.post('/1-5/AO/action-edit-providers-single', function (req, res) {
        /* 
    ...
    router.post('/1-5/AO/action-ao-add-providers-bulk', function (req, res) {
        /*
        ...
        */
        ...
        conf = "You have linked 4 new providers to T Levels"
    ...
    router.get('/1-5/AO/action-centres-question-next', function (req, res) {
    ...
    router.post('/1-5/AO/action-add-centre-single-01', function (req, res) {
        ...
        if (search.length === 0) {
            ...
            res.redirect('/1-5/AO/ao-new-provider-add-02')
        } else {
    ...
    router.get('/1-5/AO/action-add-centre-single-02', function (req, res) {
        ...
        res.redirect('/1-5/AO/ao-new-provider-add-03')
    })
    ...
    router.post('/1-5/AO/action-add-centre-many-01', function (req, res) {
        ...
        if (search.length < 1) {
            ...
            // Render page
            res.redirect('/1-5/AO/ao-many-providers-add-02')
        }
    })

    router.get('/1-5/AO/action-add-centre-many-02', function (req, res) {
        // Get index of selected provider
        var idx = req.query['index']
        req.session.data['add-ao-selected'] = req.session.data['search-matches'][idx]
        ...
        res.redirect('/1-5/AO/ao-many-providers-add-03')
    })


    // ####################### VIEW/EDIT PROVIDER PROCESS #######################

    router.post('/1-5/AO/action-view-centre-01', function (req, res) {
        ...
        if (search.length < 1) {
            ...
            // Render page
            res.redirect('/1-5/AO/ao-view-provider-02')
        }
    })

    router.get('/1-5/AO/action-view-centre-02', function (req, res) {
        // Get index of selected provider
        var idx = req.query['index']
        req.session.data['add-ao-selected'] = req.session.data['search-matches'][idx]
        ...
        res.redirect('/1-5/AO/ao-view-provider-03')
    })

    // ####################### ADD STUDENTS PROCESSES #######################

    router.post('/1-5/AO/action-students-question-next', function (req, res) {
        req.session.data['errors'] = []
        ...
        if (answer === 'add-one') {
            ...
            req.session.data['errors'].push(error)
            res.redirect('/1-5/AO/ao-view-students')
        }
    })

    router.post('/1-5/AO/action-add-student-single-01', function (req, res) {
        /*
        User first selects the T Level the learner is doing
        */
        res.redirect('/1-5/AO/ao-add-student-single-02')
    })

    router.post('/1-5/AO/action-add-student-single-02', function (req, res) {
        /*
        ...
        */
        ...
        if (tlevel === undefined) {
            ...
            req.session.data['errors'].push(error)
            res.redirect('/1-5/AO/ao-add-student-single-01')
        } else {
            res.redirect('/1-5/AO/ao-add-student-single-02')
        }
    })

    router.post('/1-5/AO/action-add-student-single-03', function (req, res) {
        /*
        ...
        */
        ...
        if (year === undefined) {
            ...
            res.redirect('/1-5/AO/ao-add-student-single-03')
        }
    })

    router.post('/1-5/AO/action-add-student-single-04', function (req, res) {
        /*
        ...
        */
        ...
        if (uln.length < 10) {
            ...
            res.redirect('/1-5/AO/ao-add-student-single-04')
        }
    })

    router.post('/1-5/AO/action-add-student-single-check', function (req, res) {
        req.session.data['errors'] = []
        ...
        res.redirect('/1-5/AO/ao-add-student-single-check')
    })

    router.post('/1-5/AO/action-view-students-details', function (req, res) {
        ...
        if (uln.length < 10) {
            ...
            error = ['#01', 'The ULN you provided is not of a correct format']
            req.session.data['errors'].push(error)
            res.redirect('/1-5/AO//ao-view-student')
        } else {
            ...
            res.redirect('/1-5/AO/ao-views-student')
        }
    })

    router.post('/1-5/AO/action-ao-add-students-bulk', function (req, res) {
        /*
        Adds students in bulk
        */
        ...
        res.redirect('/1-5/AO/action-ao-view-students')
    })

    router.post('/1-5/AO/action-add-student-single-confirm', function (req, res) {
        /*
    ...
    router.get('/1-5/AO/action-ao-view-students', function (req, res) {
        /*
        Pagination!
        */
        //checkIfActive(req)
    ...
    router.get('/1-5/AO/action-ao-views-student', function (req, res) {
        /*
    ...
    router.get('/1-5/AO/action-search-students', function (req, res) {
        /*
        ...
        */
        ...
        //req.session.data['students-ao-tmp'] = req.session.data['students-ao']
        res.redirect('/1-5/AO/ao-view-students?pageNumber=' + queryString)

    })

    router.get('/1-5/AO/action-clear-students-search', function (req, res) {
    ...
    router.get('/1-5/AO/action-clear-providers-search', function (req, res) {
    ...
    router.get('/1-5/AO/action-upload-assessments', function (req, res) {

        res.redirect('/1-5/AO/ao-add-assessments')
    })
}
